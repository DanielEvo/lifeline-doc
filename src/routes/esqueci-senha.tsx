...
export const Route = createFileRoute("/esqueci-senha")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Recupere o acesso à sua conta LifeLine de médico." },
    ],
  }),
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-3xl border border-border bg-card p-6 shadow-xl shadow-primary/5">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Informe seu e-mail e enviaremos um link para redefinir a senha. O link expira em 30
